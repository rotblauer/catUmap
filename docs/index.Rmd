...
p <-
  ggplot(df, aes(x = umap_1, y = umap_2, color = Speed)) + geom_point(alpha =
...
p <-
  ggplot(df, aes(x = umap_1, y = umap_2, color = Name)) + geom_point(alpha =
                                                                          0.5, size = size)+ guides(color = guide_legend(override.aes = list(alpha = 1,size= 3) ) )
p


p <-
  ggplot(df, aes(x = umap_1, y = umap_2, color = Activity)) + geom_point(alpha =
                                                                              0.5, size = size)+ guides(color = guide_legend(override.aes = list(alpha = 1,size= 3) ) )
p
...
p <-
  ggplot(df, aes(x = umap_1, y = umap_2, color = GU_A3)) + geom_point(alpha =
                                                                              0.5, size = size)+ guides(color = guide_legend(override.aes = list(alpha = 1,size= 3) ) )
p

p <-
  ggplot(df, aes(x = umap_1, y = umap_2, color = STUSPS)) + geom_point(alpha =
                                                                         0.5, size = size)+ guides(color = guide_legend(override.aes = list(alpha = 1,size= 3) ) )
p
...
p <-
  ggplot(dfTrim, aes(x = umap_1, y = umap_2, color = STUSPS)) + geom_point(alpha =
                                                                             0.5, size = size) + guides(color = guide_legend(override.aes = list(alpha = 1, size = 3)))
p
p + facet_wrap(~ Name)
p + facet_wrap( ~ STUSPS)
